...
<template>
    ...
    >
        <div>
            <h3 class="h3 mt-3 mb-1 text-white-50 text-center fw-bolder">
                Create New To-Do
            </h3>
        </div>
        ...
        <div class="align-self-center w-100">
            ...
            <input
                ...
                v-model="form.name"
                type="text"
                class="w-100 text-sm-start bg-dark text-white-50 border-0"
        ...
        <div class="">
            <p class="fs-6 text-danger" v-show="isErrorP">
            ...
            <button
                class="btn btn-outline-secondary w-25 m-1 align-self-center d-inline"
                @click="onCreate"
            >
                Create
            </button>
